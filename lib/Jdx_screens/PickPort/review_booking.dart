...
class _ReviewBookingScreenState extends State<ReviewBookingScreen> {
  ...
  getVehicleDetalsApi() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('https://developmentalphawizz.com/pickport/api/Authentication/api_get_vihicle_data'));
                            ...
                            children: [
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                               Text("${getVehicleModel?.data?.capName}",style: TextStyle(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(getTranslated(context, "Material Category"),style: const TextStyle(fontWeight: FontWeight.bold)),
                                             Text("${getVehicleModel?.data?.categoryName}"),
                                          ],
                                        ),
                                        Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text("₹${getVehicleModel?.data?.feeCharge}"),
                                          ],
                                        ),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                           ...
                                           changePrice ?   Text("₹ ${finalAmount.toString()}"):
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                    ...
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=> PaymentMethod1(totalAmount:finalAmount == null ?double.parse(amount.toString()):double.parse(finalAmount.toString()),amount:double.parse(amount.toString()) ,orderid: widget.oID,isCheck: changePrice,cAmount: disCountAmount,)));
                                    },
                                    child: Container(
                                      height: 50,
...
String? amt;
  ...
  getPromoCodeApi() async {
    var headers = {
      'Cookie': 'ci_session=d2f693424d60d33ace42db2d70ac2440651c98a7'
    };
